    ...
    internal class Program
    {
        ...
        public static void Aula04_05()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                for (int j = 0; j < 3; j++)
                {
                    matriz[i, j] = Convert.ToChar(i * 3 + j + 49);
            ...
            while (ganhou == false)
            {
                ...
                if (matriz[0, 0] == jogador && matriz[1, 1] == jogador && matriz[2, 2] == jogador ||
                    ...
                    matriz[0, 0] == jogador && matriz[1, 0] == jogador && matriz[2, 0] == jogador ||
                    matriz[0, 1] == jogador && matriz[1, 1] == jogador && matriz[2, 1] == jogador ||
                    matriz[0, 2] == jogador && matriz[1, 2] == jogador && matriz[2, 2] == jogador ||
                    matriz[0, 0] == jogador && matriz[0, 1] == jogador && matriz[0, 2] == jogador ||
                    matriz[1, 0] == jogador && matriz[1, 1] == jogador && matriz[1, 2] == jogador ||
                    matriz[2, 0] == jogador && matriz[2, 1] == jogador && matriz[2, 2] == jogador
                    )
                {
                    ganhou = true;
                    Console.WriteLine($"\nJogador {aux} ganhou!");
            ...
            if (ganhou == false)
                Console.WriteLine("Deu Velha! O jogo empatou.");
